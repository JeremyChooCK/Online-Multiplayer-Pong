...
env = environ.Env()
# Assuming your .env file is at the root of your Django project
...
SECRET_KEY = 'django-insecure-piwyrwei=n4(fiz9x^@58y3rxe%a^58el$@bj+g%%_l2hz$p!o'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'frontend' / 'templates' / 'html',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
